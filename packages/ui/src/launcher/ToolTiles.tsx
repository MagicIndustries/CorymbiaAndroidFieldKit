 ...
 * doctrine rule 21 on the component below) — there is currently no way to
 ...
 *
 * **`available` is doctrine rule 21 made structural.** Batching and the media
 ...
 * doctrine rule 21 forbids, whether that "nothing" is silence or a badge
